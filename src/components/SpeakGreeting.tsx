...
import { Volume2, Mic, MicOff, Play, ArrowRight, RotateCcw, MessageCircle } from 'lucide-react';
...
const SpeakGreeting: React.FC<SpeakGreetingProps> = ({
  greetings,
  currentIndex,
  totalGreetings,
  onNavigate,
  ...
  const checkPronunciation = (spokenText: string) => {
    const targetText = currentGreeting.kannada.toLowerCase().trim();
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="magical-card rounded-3xl shadow-2xl p-8 max-w-3xl w-full text-center animate-glow">
        ...
        {/* Instruction */}
        <div className="text-lg font-semibold text-gray-700 mb-4">
          Listen, then speak the Kannada greeting!
        </div>
        ...
        <div className="bg-gradient-to-r from-green-200 via-teal-200 to-blue-200 rounded-2xl p-8 mb-8 shadow-lg animate-glow">
          <div className="text-xl font-semibold text-gray-800 mb-4">
            Practice speaking this greeting:
          </div>
          ...
          {/* Kannada Greeting */}
          <div className="text-3xl sm:text-5xl font-bold py-6 px-8 rounded-2xl shadow-xl mb-6 bg-gradient-to-br from-green-300 to-teal-300 text-green-800">
