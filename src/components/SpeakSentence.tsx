...
import { Volume2, Mic, MicOff, Play, ArrowRight, RotateCcw, MessageSquare } from 'lucide-react';
...
const SpeakSentence: React.FC<SpeakSentenceProps> = ({
  sentences,
  currentIndex,
  totalSentences,
  onNavigate,
    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="magical-card rounded-3xl shadow-2xl p-8 max-w-3xl w-full text-center animate-glow">
        <h2 className="text-3xl font-bold gradient-text mb-6 flex items-center justify-center">
          <MessageSquare className="h-10 w-10 mr-2 text-violet-500 animate-sparkle" />
        ...
        {/* Sentence Display */}
        <div className="bg-gradient-to-r from-violet-200 via-purple-200 to-pink-200 rounded-2xl p-8 mb-8 shadow-lg animate-glow">
          ...
          {/* Kannada Sentence */}
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold py-6 px-8 rounded-2xl shadow-xl mb-6 bg-gradient-to-br from-violet-300 to-purple-300 text-violet-800">
